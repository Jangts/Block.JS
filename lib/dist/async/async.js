...
tangram.init().block([
	...
	var _ανώνυμος_variable_1 = pandora.clone(root);
	var location = pandora.remove(_ανώνυμος_variable_1, 'location'), console = pandora.remove(_ανώνυμος_variable_1, 'console'), FormData = pandora.remove(_ανώνυμος_variable_1, 'FormData');
