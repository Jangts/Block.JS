...
block([
    ...
    declare('see.ThreeDimensionalEyes', _.medias.Photos, {
        ...
        loadBox: function() {
            var that = this;
            this.loadingArea = _.dom.query('.ib-3deyes-loading', this.Element)[0] || _.dom.create('div', this.Element, {
        ...
        noData: function() {
            this.images = [];
            var that = this;
            _.each(_.dom.query('img.ib-3deyes-item', this.Element), function() {
