...
tangram.block([
    ...
    _('see.highlight', {
            ...
            DFS: function(o, callback, type, visited) {
                ...
                for (var i in o) {
                    if (o.hasOwnProperty(i)) {
                        ...
                        if (_.util.type.Obj.native(o[i]) === 'Object' && !visited[_.see.highlight.util.objId(o[i])]) {
                            visited[_.see.highlight.util.objId(o[i])] = true;
                            _.see.highlight.languages.DFS(o[i], callback, null, visited);
                        } else if (_.util.type.Obj.native(o[i]) === 'Array' && !visited[_.see.highlight.util.objId(o[i])]) {
                            visited[_.see.highlight.util.objId(o[i])] = true;
        ...
        renderAll: function(callback) {
            ...
            var elements = env.elements || _.dom.query(env.selector);
