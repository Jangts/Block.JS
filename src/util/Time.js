	...
	pandora.declareClass('util.Time', {
		_init: function (time) {
			...
			switch (arguments.length) {
				case 1: switch(typeof time) {
					...
					t = time;
					break;
					case 'number': t = parseInt(time);
					break;
				}
				break;
				case 2: t = getArray(arguments[0], arguments[1]);
				break;
				case 3: t = getArray(arguments[0], arguments[1], arguments[2]);
				break;
				case 4: t = getArray(arguments[0], arguments[1], arguments[2], arguments[3]);
				break;
				case 5: t = getArray(arguments[0], arguments[1], arguments[2], arguments[3], arguments[4]);
				break;
			...
			switch(typeof t) {
				...
				break;
				case 'string': date = new Date(t);
				break;
				case 'undefined': date = new Date();
				break;
			}
		...
		when: function (hour) {
			...
			switch (hour) {
				...
				case 14: case 15: case 16: case 17: return'AFTN';
				case 18: case 19: case 20: case 21: return'EVN';
				case 22: case 23: case 0: return'NIT';
			};
		},
		utc: function (sets) {
			...
			return {
				...
				year: dates[this.id].getUTCFullYear(),
				hour: dates[this.id].getUTCHours(),
				minute: dates[this.id].getUTCMinutes(),
				second: dates[this.id].getUTCSeconds(),
				ms: dates[this.id].getUTCMilliseconds()
			};
		},
		toString: function (type) {
			switch (type) {
				...
				case 'local': return dates[this.id].toLocaleString();
				case 'localtime': return dates[this.id].toLocaleTimeString();
				case 'localdate': return dates[this.id].toLocaleDateString();
			}
