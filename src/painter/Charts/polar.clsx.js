...
tangram.block([
    ...
    _.painter.Charts.prototype.buildPolar = function() {
        var polar = _.util.obj.deepMerge(_.painter.Charts.util.defaults.polar, this.options.polar || {}),
            angleAxis = _.util.obj.deepMerge(_.painter.Charts.util.defaults.angleAxis, this.options.angleAxis || {}),
            radiusAxis = _.util.obj.deepMerge(_.painter.Charts.util.defaults.radiusAxis, this.options.radiusAxis || {});
        ...
        if (this.polar === null) {
            this.polar = new _.painter.Charts.scale.Polar(polarOptions);
            events.bindHover(this, function(evt) {
                var actives = [],
                    ...
                    charts = _.util.arr.merge(this.polar.charts.lines, this.polar.charts.areas, this.polar.charts.scatters);
