...
(function (global, factory) {
    ...
    var name = 'tangram.js javascript framework', version = '0.9.00', website = 'tangram.js.cn',
        ...
        calculateRelativePath = function (uri, reference) {
            ...
            for (i; i < referdir_array.length; i++) {
                if (pathname_array[i] != referdir_array[i]) {
                    var l = 0, len = referdir_array.length - i;
                    for (l; l < len; l++) {
                        pathname += '../';
                    }
                    break;
                        ...
                        switch (arguments.length) {
                            ...
                            default:
                                if ((typeof storage.locales[namespace] === 'object') && (typeof arguments[1] === 'string')) {
                                    var lang = arguments[1].toLowerCase(), value;
    ...
    var block = function (includes, callback, blockname) {
        ...
        Block = declareClass({
             ...
             */
            loadnext: function () {
                var that = this, filetype, arr, url;
    ...
    var tangram = {
        ...
        config: function (options) {
            ...
            if (options.mainUrl) {
                var _maindir = maindir, anchor = doc.createElement('a');
