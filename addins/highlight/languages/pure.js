...
tangram.block('$_/see/highlight/highlight', function(_, global, imports, undefined) {
    ...
    inlineLanguages.forEach(function(lang) {
        ...
        if (highlight.languages[alias]) {
            var o = {};
            o['inline-lang-' + alias] = {
                pattern: RegExp(inlineLanguageRe.replace('{lang}', lang.replace(/([.+*?\/\\(){}\[\]])/g, '\\$1')), 'i'),
                inside: _.copy(highlight.languages.pure['inline-lang'].inside)
            };
            o['inline-lang-' + alias].inside.rest = _.copy(highlight.languages[alias]);
            highlight.languages.insertBefore('pure', 'inline-lang', o);
        }
    });
